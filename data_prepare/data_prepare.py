...
# load data
data_clinical = pd.read_csv("input/NSCLC1_clinical_input.csv")
data_tissue = pd.read_csv("input/NSCLC1_tissue_first_line_treatment_input.csv")
...
columns = ['patient_id', 'tissue_id', 'age', 'gender', 'stage', 'smoking', 'medication',
           'pfs', 'best therapeutic response', "progresses", "TP53", "number of co-mutated genes"]
...
data_clinical['best therapeutic response'] = data_clinical['best therapeutic response'].replace(
    {'PR': 0, 'SD': 1, 'PD': 2})
